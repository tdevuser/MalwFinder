...
#define CREATE_XVER(maj,min,build) maj ## , ## min ## ,1312, ## build
#define CREATE_FVER(maj,min,build) maj ## . ## min ## .1312. ## build
#define CREATE_PVER(maj,min,build) maj ## , ## min ## ,1312, ## build
